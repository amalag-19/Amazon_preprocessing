...
source(file = "/Users/Amal/Box Sync/PSU/Summer 2018/Main_Research/Network Models/Project 5 (Bipartite)/code/bipartite_All/bipartite_All.R")

########################################################################################################
## Running the Amazon data
load(file = "/Users/Amal/Box Sync/PSU/Summer 2018/Main_Research/Network Models/Project 5 (Bipartite)/amazon_2014_10core/amazon_adjacency.RData")

load(file = "/Users/Amal/Box Sync/PSU/Summer 2018/Main_Research/Network Models/Project 5 (Bipartite)/amazon_2014_10core/amazon_rating.RData")

load(file = "/Users/Amal/Box Sync/PSU/Summer 2018/Main_Research/Network Models/Project 5 (Bipartite)/amazon_2014_10core/df_reviewer_2014_10core.RData")

load(file = "/Users/Amal/Box Sync/PSU/Summer 2018/Main_Research/Network Models/Project 5 (Bipartite)/amazon_2014_10core/df_product_2014_10core.RData")

load(file = "/Users/Amal/Box Sync/PSU/Summer 2018/Main_Research/Network Models/Project 5 (Bipartite)/amazon_2014_10core/df_fair_2014_10core.RData")

load(file = "/Users/Amal/Box Sync/PSU/Summer 2018/Main_Research/Network Models/Project 5 (Bipartite)/amazon_2014_10core/df_good_2014_10core.RData")
...
net_result<-wrapper_bipartite_model2(net_adjacency = amazon_adjacency, net_rating = amazon_rating, nclust1 = 3, nclust2 = 3, thres = 10^(-6),theta_init = theta_init, beta_u_init = beta_u_init, beta_p_init = beta_p_init, omega_init = omega_init,  mu_init = mu_init, delta_u_init = delta_u_init, delta_p_init = delta_p_init, cov_u =matrix((df_fair[,"num_product"]/N2),N1,1), cov_p = matrix((df_good[,"num_reviewer"]/N1),N2,1), sim_indicator = 0,R = 5)
...
net_result<-wrapper_bipartite_model3(net_adjacency = amazon_adjacency, net_rating = amazon_rating, nclust1 = 3, nclust2 = 3, thres = 10^(-6),theta_init = theta_init, beta_u_init = beta_u_init, beta_p_init = beta_p_init, omega_init = omega_init,  mu_init = mu_init, delta_u_init = delta_u_init, delta_p_init = delta_p_init, cov_u_outer = as.matrix(df_fair[,c("mean_rating","Score")]), cov_p_outer = as.matrix(df_good[,c("mean_rating","Score")]), cov_u_ordistic = matrix(df_fair[,"num_product"],N1,1), cov_p_ordistic = matrix(df_good[,"num_reviewer"],N2,1), sim_indicator = 0,R = 5)
